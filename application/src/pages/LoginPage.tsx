        ...
        <form onSubmit={handleSubmit}>
          <Card>
            ...
            <CardFooter className="flex flex-col gap-3 p-6 pt-0">
              ...
              {(import.meta.env.VITE_TEST_ADMIN_EMAIL || import.meta.env.VITE_TEST_USER_EMAIL) && (
                <div className="w-full text-xs text-[#6B7280] bg-[#F9FAFB] p-3 rounded-[4px] border border-[#E5E7EB] space-y-1 mt-2">
                  <div className="font-semibold text-[#374151] flex items-center justify-between">
                    ...
                    <button
                      type="button"
                      onClick={() => {
                        if (import.meta.env.VITE_TEST_ADMIN_EMAIL) setEmail(import.meta.env.VITE_TEST_ADMIN_EMAIL);
                        if (import.meta.env.VITE_TEST_USER_PASSWORD) setPassword(import.meta.env.VITE_TEST_USER_PASSWORD);
                      }}
