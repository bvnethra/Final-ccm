...
export async function getCurrentUserProfile(authUserId: string): Promise<AuthUser> {
  ...
  return {
    ...
    tenantName: tenantName || 'Nethra Metrology Services Ltd',
    tenantCode: tenantCode || 'TNT-NETHRA',
    organizationId: profile.organization_id,
    organizationName: organizationName || 'Central Calibration Lab - HQ',
    organizationCode: organizationCode || 'ORG-HQ',
    roles: roleCodes,
