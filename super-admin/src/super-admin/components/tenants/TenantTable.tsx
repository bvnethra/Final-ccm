    ...
    <div className="space-y-5">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs sm:text-sm text-slate-500 mt-0.5">
              Tenant Registry &amp; Multi-Tenant Operational Isolation ({totalCount} Registered)
            </p>
          </div>
        </div>
      ...
      <div className="bg-white p-3 sm:p-4 rounded-xl border border-slate-200 shadow-xs flex flex-col lg:flex-row lg:items-center justify-between gap-3">
        <div className="relative flex-1">
          ...
          <input
            type="text"
            placeholder="Search by tenant name, code, admin email, city..."
            value={search}
      ...
      <div className="bg-white rounded-xl border border-slate-200 overflow-hidden shadow-xs">
        {isLoading ? (
          ...
          <div className="py-20 text-center text-slate-500 flex flex-col items-center gap-3">
            ...
            <div className="text-base font-bold text-slate-800">No Tenants Found</div>
        ...
        {paginatedData && (
          <div className="p-3.5 border-t border-slate-200 bg-white flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs text-slate-500">
            <div>
              ...
              <span className="font-semibold text-slate-800">{paginatedData.total}</span> tenants
            </div>
